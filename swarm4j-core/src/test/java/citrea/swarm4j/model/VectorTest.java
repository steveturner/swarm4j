...
/*test("7.g log compaction", function (test) {   TODO HORIZON
    ...
    public void test7l_event_relay() throws SwarmException {
        ...
        assertArrayEquals(new String[]{"Smith", "Smith", "Smith"}, ids.toArray(new String[ids.size()]));
        ...
        assertArrayEquals(new String[]{"Smith", "Smith"}, ids.toArray(new String[ids.size()]));
    }
