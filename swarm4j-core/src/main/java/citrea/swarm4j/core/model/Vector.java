...
import citrea.swarm4j.core.callback.ProxyListener;
...
public class Vector<T extends Syncable> extends Syncable {
    ...
    public void in(FullSpec spec, JsonValue value) throws SwarmException {
     ...
     */
    @SwarmOperation(kind = SwarmOperationKind.Logged)
    public void rm(FullSpec spec, JsonValue value) throws SwarmException {
